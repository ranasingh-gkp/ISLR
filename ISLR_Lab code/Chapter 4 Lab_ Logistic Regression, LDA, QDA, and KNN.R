...
summary(Purchase)
348/5822
#A good way to handle this problem is to standardize the data so that all standardize variables are given a mean of zero and a standard deviation of one. Then all variables will be on a comparable scale. (we dont use for qualitative data)
standardized.X=scale(Caravan[,-86])
var(Caravan[,1])#to check variance
var(Caravan[,2])
var(standardized.X[,1])#to check variance
